...
if (getenv('app_baseURL') || getenv('app.baseURL')) {
    ...
    if (isset($_SERVER['HTTP_HOST'])) {
      ...
      $protocol = (isset($_SERVER['HTTPS']) && $_SERVER['HTTPS'] != 'off') || ( isset($_SERVER['HTTP_X_FORWARDED_PROTO']) && $_SERVER['HTTP_X_FORWARDED_PROTO'] == 'https' ) ? 'https://' . $_SERVER['HTTP_HOST'] . $folderProject : 'http://' . $_SERVER['HTTP_HOST'] . $folderProject;
      defined('BASE') || define('BASE', $protocol);
  
      $protocol = (isset($_SERVER['HTTPS']) && $_SERVER['HTTPS'] != 'off') || ( isset($_SERVER['HTTP_X_FORWARDED_PROTO']) && $_SERVER['HTTP_X_FORWARDED_PROTO'] == 'https' ) ? 'https://' . $_SERVER['HTTP_HOST'] : 'http://' . $_SERVER['HTTP_HOST'];
